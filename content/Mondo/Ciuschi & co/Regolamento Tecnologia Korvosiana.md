...
Tipologie di Oggetti/armi/armature attualmente in mano alla SAP:
----------------------------------------------------------------

Numero di poli (se presenti):
...
## Oggetti Unici / Artefatti

### Verga Planare di Vickster - prototipo 00
...
Batteria: 1 carica
Questa piccola verga è stata creata assieme alla Verga Planare; in questo modo essa ha registrato lo stesso algoritmo di spostamento che la Verga Planare usa per il piano "criptato".
Usando la carica della batteria, permette di raggiungere la Verga Planare a cui è legata ovunque essa si trovi, anche quando viene usata la "criptazione". 